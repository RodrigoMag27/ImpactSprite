...
#Sprites
@onready var ZZZ_sprite: Sprite2D = $ZZZ

#Textures
var normal_head: Texture2D = preload("res://Assets/MainCharacter/Head.png")
var sleep_head: Texture2D = preload("res://Assets/MainCharacter/HeadSleeping.png")
...
func off_active():
	...
	moving = false
	jumping = false
	ZZZ_sprite.visible = false
	$Skeleton2D/Torso2/Head2.texture = normal_head
	player_animation.play("idle")
...
func _on_sleep_pressed():
	action_timer(moving_timer)
	UI.visible = false
	$Skeleton2D/Torso2/Head2.texture = sleep_head
	ZZZ_sprite.visible = true
	stamina += 10
